...
{
	//Executes entities under a certain health
	public class OrbitalLaserBarrageAbility : AbilityBase
	{
		[Header("Ability Data")]
		[SerializeField] private float laserDamage;
		[SerializeField, MaxValue("@laserDamage")] private float shockwaveDamage;
		[SerializeField, Range(0f, 0.9f)] private float executeBelowHealth;
		...
		public override void Execute()
		{
			...
			new OrbitalLaserBarrageSpell.Builder()
				.InitCollisionLayers(_includeLayers)
				.InitLaserDamage(laserDamage)
				.InitShockwaveDamage(shockwaveDamage)
				.InitExecuteBelowHealthPercent(executeBelowHealth)
				.InitOwner(transform)
				.Build(spawn.GetComponent<OrbitalLaserBarrageSpell>())
				.Execute();
		...
		public class Builder
		{
			...
			public OrbitalLaserBarrageAbility Build(OrbitalLaserBarrageAbility instance)
			{
