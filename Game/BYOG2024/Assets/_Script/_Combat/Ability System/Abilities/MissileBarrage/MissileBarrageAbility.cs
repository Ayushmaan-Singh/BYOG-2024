...
{
	public class MissileBarrageAbility : AbilityBase
	{
		[Header("Ability Data")]
		...
		public override void Execute()
		{
			...
			new MissileBarrageSpell.Builder()
				.InitCollisionLayers(_includeLayers)
				.InitDamagePerHit(damagePerHit)
				.InitOwner(transform)
				.Build(spawn.GetComponent<MissileBarrageSpell>())
				.Execute();
		...
		public class Builder
		{
			...
			public MissileBarrageAbility Build(MissileBarrageAbility instance)
			{
