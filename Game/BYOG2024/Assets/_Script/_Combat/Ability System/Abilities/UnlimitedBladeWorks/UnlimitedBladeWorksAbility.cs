...
{
	public class UnlimitedBladeWorksAbility : AbilityBase
	{
		[Header("Ability Data")]
		...
		public override void Execute()
		{
			...
			new UnlimitedBladeWorksSpell.Builder()
				.InitCollisionLayers(_includeLayers)
				.InitDamagePerHit(damagePerHit)
				.InitOwner(transform)
				.Build(spawn.GetComponent<UnlimitedBladeWorksSpell>())
				.Execute();
		...
		public class Builder
		{
			...
			public UnlimitedBladeWorksAbility Build(UnlimitedBladeWorksAbility instance)
			{
