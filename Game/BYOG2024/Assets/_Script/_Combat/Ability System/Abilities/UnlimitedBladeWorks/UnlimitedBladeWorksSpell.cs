...
{
	public class UnlimitedBladeWorksSpell : SpellBase
	{
		...
		public UnlimitedBladeWorksSpell Execute()
		{
		...
		private void OnParticleEffectFinished(ParticleFX particleFX)
		{
			...
			UnlimitedBladeWorksAbility ability = GetComponent<OwnerOfThisObject>().Owner?.GetComponent<UnlimitedBladeWorksAbility>();
			if (ability.OrNull())
		...
		public class Builder
		{
			...
			public UnlimitedBladeWorksSpell Build(UnlimitedBladeWorksSpell instance)
			{
