...
{
	public class MinefieldAbility : AbilityBase
	{
		[Header("Ability Data")]
		[SerializeField,Tooltip("It is just graze damage keep it very low")] private float explosionDamage;
		...
		public override void Execute()
		{
			...
			new MinefieldSpell.Builder()
				.InitCollisionLayers(_includeLayers)
				.InitExplosionDamage(explosionDamage)
				.InitOwner(transform)
				.Build(spawn.GetComponent<MinefieldSpell>())
				.Execute();
		...
		public class Builder
		{
			...
			public MinefieldAbility Build(MinefieldAbility instance)
			{
